...
Definition of all constants for the game ofBughouse
...
CHANNEL_MAPPING_CONST = {"color": 0, "total_mv_cnt": 1, "castling": 2, "no_progress_cnt": 6}

# define two constants indicating the number of channels for the input plane presentation
NB_CHANNELS_POS = 27
NB_CHANNELS_CONST = 7
NB_CHANNELS_FULL = NB_CHANNELS_POS + NB_CHANNELS_CONST
...
MAX_NB_NO_PROGRESS = 40  # after 40 moves of no progress the 40 moves rule for draw applies
